...
namespace EmeraldAI
{
    ...
    public class EmeraldAISystem : MonoBehaviour
    {
        ...
        public Animator AIAnimator
        {
            get
            {
                if (aiAnimator == null) aiAnimator = GetComponentInChildren<Animator>();
                return aiAnimator;
            }
            set { aiAnimator = value; }
        }
        Animator aiAnimator;
        ...
        /// <summary>
        /// Used for triggering a Ranged Attack.
        /// Do NOT call directly, use EmeraldAttackEvent instead.
        /// </summary>
